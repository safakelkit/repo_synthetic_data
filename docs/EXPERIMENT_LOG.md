...
- **Recorded evidence:** run records, generated image/control hashes, exact environment, logical GPU, wall/load/inference time, peak allocated/reserved VRAM, and human-review decisions. Physical GPU identity was not captured for every run.
...
- **SDXL pilot-v2 correction:** Preserve the immutable class IDs and copy-paste asset eligibility, but use a separate GenAI-control suitability policy. Matches, Pliers, Shaver, Saw, Aerosol can, and Mobile phone each receive four visually representative accepted masks. Prompts explicitly describe matchbox, combination pliers, disposable razor, handheld hacksaw, aerosol spray can, and smartphone semantics. Eight scene-specific support polygons replace the shared pilot-v1 polygon.
- **SDXL pilot-v2 execution:** Complete, 64/64 images and controls; four images/class; 64 unique output hashes. Aggregate inference 1,018.154 s, mean 15.909 s/image, maximum 18.974 s/image. No annotation or degradation was applied and training use remains forbidden.
- **SDXL pilot-v2 visual review:** Layout diversity improved and Saw was more recognizable than in v1. Knife and Screwdriver were consistently clear. Shaver failed in all four cases; Matches and Pliers remained mostly ambiguous. Aerosol can, Mobile phone, Battery, Laptop, and some Scissors/Wrench cases also showed class ambiguity, malformed geometry, or extra-object violations.
- **SDXL pilot-v2 disposition:** Structural/technical pass, visual rejection for canonical promotion. Do not launch full-scale generation from this configuration.
- **SDXL targeted pilot-v3 execution/review:** Complete, 28/28 unique images and controls; aggregate inference 444.317 s, mean 15.868 s/image. Matches, Shaver, and Mobile phone improved materially; Pliers remains mixed. Aerosol can and Battery continue to be generated as generic bottle/device/remote-like objects. Laptop samples often contain another computer or an unclear primary laptop. Technical pass, visual rejection for canonical promotion.
- **SDXL remaining-class pilot-v4 execution/review:** Complete, 16/16 outputs with valid hashes and full manifest-v2 provenance. Runtime was 262.081 s including 4.800 s model load; aggregate inference 256.519 s (16.032 s/image mean); peak allocated/reserved VRAM was 7.735/10.379 GiB on RTX 3090. Strict viable-candidate review accepted Pliers 4/4, Aerosol can 0/4, Battery 2/4, and Laptop 2/4 (8/16 overall). Pliers is resolved; 9V Battery and two Laptop samples are viable; AA Battery remains malformed; Aerosol is still systematically rendered as a fixture/device. V4 is not promoted wholesale.
