...
- **SDXL remaining-class pilot-v4 prepared:** 16 images covering Pliers, Aerosol can, Battery, and Laptop in four scenes each. V4 removes prompt–silhouette subtype conflicts, selects explicit plier/open-laptop assets, distinguishes AA and 9V battery prompts/controls, simplifies aerosol edges, and records per-class ControlNet scales. Preflight and 16/16 static control renders passed; GPU generation/review pending.
