...
| SDXL Aerosol pilot-v5 | Genuine aerosol silhouettes without internal pseudo-nozzle edges; four frozen scenes at ControlNet scales 0.45/0.60/0.75/0.90 | Implemented in `genai_aerosol_scale_pilot_v5.yaml`; 16 unique controls passed static validation; GPU run pending |
